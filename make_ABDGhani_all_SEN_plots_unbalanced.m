...
matlab2tikz('filename',sprintf('AbdulGhani_val_SEN_unbalanced.tex'));
hgexport(gcf, 'AbdulGhani_val_SEN_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_val_SEN_unbalanced.fig')
...
matlab2tikz('filename',sprintf('AbdulGhani_tra_SEN_unbalanced.tex'));
hgexport(gcf, 'AbdulGhani_tra_SEN_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_tra_SEN_unbalanced.fig')

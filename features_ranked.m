...
% According the feature filter routine, following is the list of list of
% features in terms of their ranks
...
% HOMA_IR
HOMA_IR = G0.*I0/405; % changed from 22.5 to 405 since values are in mg/dL
...
ft.FPG = table2array(SAHS_clean(:, 4));

ft.PG30 = table2array(SAHS_clean(:, 5));

ft.PG60 = table2array(SAHS_clean(:, 6));

ft.PG120 = table2array(SAHS_clean(:, 7));



ft.FPI = table2array(SAHS_clean(:, 8));

ft.PI30 = table2array(SAHS_clean(:, 9));

ft.PI60 = table2array(SAHS_clean(:, 10));

ft.PI120 = table2array(SAHS_clean(:, 11));
...
% save data_plus_features_eth.mat SAHS_features SAHS_clean ft Labels


% Save only ranked features
save features_all 
% save clean_table_ranked.mat SAHS_features SAHS_clean ft Labels
% save data_plus_features_ranked.mat SAHS_features SAHS_clean ft Labels
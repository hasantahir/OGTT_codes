...
load Training_plus_Validation_sofcare_100iters
...
%         tr_SEN(i,j) = Training_plus_Validation_results(j).tr_max_sn(i);
%         tr_ACC(i,j) = Training_plus_Validation_results(j).tr_acc_max_sn(i);
%         tr_SP(i,j) = Training_plus_Validation_results(j).tr_sp_max_sn(i);
%         tr_Features{i,j} = char((Training_plus_Validation_results(j).features{i}));
%         
...
%                 % Maximized Accuracy
%         tr_SP(i,j) = Training_plus_Validation_results(j).tr_sp_max_acc(i);
%         tr_ACC(i,j) = Training_plus_Validation_results(j).tr_max_acc(i);
%         tr_SEN(i,j) = Training_plus_Validation_results(j).tr_sn_max_acc(i);
%         tr_Features{i,j} = char((Training_plus_Validation_results(j).features{i}));
%         
...
errorbar(1:8,(min_val_ACC+max_val_ACC)/2,(max_val_ACC-min_val_ACC)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','blue','MarkerFaceColor','blue',...
    'LineStyle','none','Color', 'blue')

errorbar(1:8,(min_val_SEN+max_val_SEN)/2,(max_val_SEN-min_val_SEN)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','red','MarkerFaceColor','red',...
    'LineStyle','none','Color', 'red')


errorbar(1:8,(min_val_SP+max_val_SP)/2,(max_val_SP-min_val_SP)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','green','MarkerFaceColor','green',...
    'LineStyle','none','Color', 'green')

h1 = plot(1:8,mean_val_ACC, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','blue',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h2 = plot(1:8,mean_val_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','red',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h3 = plot(1:8,mean_val_SP, 's','MarkerEdgeColor',[0 0 0],...
...
matlab2tikz('filename',sprintf('Sofcare_val_from_train_SPs_unbalanced.tex'));
hgexport(gcf, 'Sofcare_val_from_train_SPS_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('Sofcare_val_from_train_SPS_unbalanced.fig')
...
errorbar(1:8,(min_tr_ACC+max_tr_ACC)/2,(max_tr_ACC-min_tr_ACC)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','blue','MarkerFaceColor','blue',...
    'LineStyle','none','Color', 'blue')

errorbar(1:8,(min_tr_SEN+max_tr_SEN)/2,(max_tr_SEN-min_tr_SEN)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','red','MarkerFaceColor','red',...
    'LineStyle','none','Color', 'red' )
...
errorbar(1:8,(min_tr_SP+max_tr_SP)/2,(max_tr_SP-min_tr_SP)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','green','MarkerFaceColor','green',...
    'LineStyle','none','Color', 'green')

h1 = plot(1:8,mean_tr_ACC, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','blue',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h2 = plot(1:8,mean_tr_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','red',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h3 = plot(1:8,mean_tr_SP, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','green',...
    'MarkerSize',9,...
    'LineWidth',0.5);
...
matlab2tikz('filename',sprintf('Sofcare_tra_SPs_unbalanced.tex'));
hgexport(gcf, 'Sofcare_tra_SPS_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('Sofcare_tra_SPS_unbalanced.fig')
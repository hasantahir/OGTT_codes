...
% load Training_plus_Validation_results_rankedulGhani_unbalanced_100iters Training_plus_Validation_results
% load Training_plus_Validation_results_ranked_100iters
load Training_plus_Validation_results_ranked_100iters
...
matlab2tikz('filename',sprintf('ranked_val_SPs.tex'));
hgexport(gcf, 'ranked_val_SPs.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_val_SPs.fig')
...
errorbar(1:8,(min_tra_ACC + max_tra_ACC)/2,(max_tra_ACC - min_tra_ACC)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','blue','MarkerFaceColor','blue',...
    'LineStyle','none','Color', 'blue')

errorbar(1:8,(min_tra_SEN+max_tra_SEN)/2,(max_tra_SEN-min_tra_SEN)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','red','MarkerFaceColor','red',...
    'LineStyle','none','Color', 'red' )
...
errorbar(1:8,(min_tra_SP+max_tra_SP)/2,(max_tra_SP-min_tra_SP)/2,...
    '-s','MarkerSize',.1,...
    'MarkerEdgeColor','green','MarkerFaceColor','green',...
    'LineStyle','none','Color', 'green')

h1 = plot(1:8,mean_tra_ACC, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','blue',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h2 = plot(1:8,mean_tra_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','red',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h3 = plot(1:8,mean_tra_SP, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','green',...
    'MarkerSize',9,...
    'LineWidth',0.5);

% plot(1:8,mean_tr_ACC, 's','MarkerEdgeColor',[0 0 0],...
...
matlab2tikz('filename',sprintf('ranked_tra_SPs.tex'));
hgexport(gcf, 'ranked_tra_SPs.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_tra_SPs.fig')
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
matlab2tikz('filename',sprintf('boxpl_ranked_val_SP.tex'));
hgexport(gcf, 'boxpl_ranked_val_SP.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_val_SP.fig')
...
matlab2tikz('filename',sprintf('boxpl_ranked_val_SEN.tex'));
hgexport(gcf, 'boxpl_ranked_val_SEN.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_val_SEN.fig')
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
matlab2tikz('filename',sprintf('boxpl_ranked_val_ACC.tex'));
hgexport(gcf, 'boxpl_ranked_val_ACC.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_val_ACC.fig')
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
matlab2tikz('filename',sprintf('boxpl_ranked_tra_SP.tex'));
hgexport(gcf, 'boxpl_ranked_tra_SP.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_tra_SP.fig')
...
matlab2tikz('filename',sprintf('boxpl_ranked_tra_SEN.tex'));
hgexport(gcf, 'boxpl_ranked_tra_SEN.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_tra_SEN.fig')
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
matlab2tikz('filename',sprintf('boxpl_ranked_tra_ACC.tex'));
hgexport(gcf, 'boxpl_ranked_tra_ACC.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('ranked_tra_ACC.fig')
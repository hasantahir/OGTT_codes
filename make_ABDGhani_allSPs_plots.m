...
grid on; box on
matlab2tikz('filename',sprintf('AbdulGhani_val_SPs.tex'));

hgexport(gcf, 'AbdulGhani_val_SPS.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
...
legend('Accuracy', 'Sensitivity','Specificity','location','southeast');
grid on; box on
matlab2tikz('filename',sprintf('AbdulGhani__tra_SPs.tex'));

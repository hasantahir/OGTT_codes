...
matlab2tikz('filename',sprintf('boxpl_ACC_best4_lin_bal.tex'));
hgexport(gcf, 'boxpl_ACC_best4_lin_bal.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('boxpl_ACC_best4_lin_bal.fig')
print(gcf,'boxpl_ACC_best4_lin_bal.png','-dpng','-r900');
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
matlab2tikz('filename',sprintf('boxpl_SP_best4_lin_bal.tex'));
hgexport(gcf, 'boxpl_SP_best4_lin_bal.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('boxpl_SP_best4_lin_bal.fig')
print(gcf,'boxpl_SP_best4_lin_bal.png','-dpng','-r900');

...
matlab2tikz('filename',sprintf('AbdulGhani_val_SPs_unbalanced.tex'));
hgexport(gcf, 'AbdulGhani_val_SPS_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_val_SPS_unbalanced.fig')

...
box_cons = 2e2;%logspace(-5,3,10);
sigma = linspace(.01, 5, 20);


for iter = 1 : 10
%     for j = 1 : 10
        %     for NbF = 3 : 3 % : 3 %Features Selected (60 in total)
        
        % numFeatures = 10;
        
        features = [1 2 3 ];%combinator(numFeatures,NbF,'c'); % combinator
        ...
        SP = p_model.Specificity
        SN = p_model.Sensitivity
        ACC = p_model.CorrectRate
%     end
    % Perform validation on the HO data using the averaged CV model

...
matlab2tikz('filename',sprintf('AbdulGhani_val_ACC_balanced.tex'));
hgexport(gcf, 'AbdulGhani_val_ACC_balanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_val_ACC_balanced.fig')
...
matlab2tikz('filename',sprintf('AbdulGhani_tra_ACC_balanced.tex'));
hgexport(gcf, 'AbdulGhani_tra_ACC_balanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_tra_ACC_balanced.fig')

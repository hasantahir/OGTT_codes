...
load TpV_newbest4_rabf_bal_11 TpV
...
% matlab2tikz('filename',sprintf('boxpl_ACC_newbest4_rbf_bal_lose1.tex'));
% hgexport(gcf, 'boxpl_ACC_newbest4_rbf_bal_lose1.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
% savefig('boxpl_ACC_newbest4_rbf_bal_lose1.fig')
% print(gcf,'boxpl_ACC_newbest4_rbf_bal_lose1.png','-dpng','-r900');
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
% matlab2tikz('filename',sprintf('boxpl_SP_newbest4_rbf_bal_lose1.tex'));
% hgexport(gcf, 'boxpl_SP_newbest4_rbf_bal_lose1.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
% savefig('boxpl_SP_newbest4_rbf_bal_lose1.fig')
% print(gcf,'boxpl_SP_newbest4_rbf_bal_lose1.png','-dpng','-r900');

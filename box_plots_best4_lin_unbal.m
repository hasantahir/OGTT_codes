...
matlab2tikz('filename',sprintf('boxpl_ACC_best4_lin_unbal.tex'));
hgexport(gcf, 'boxpl_ACC_best4_lin_unbal.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('boxpl_ACC_best4_lin_unbal.fig')
print(gcf,'boxpl_ACC_best4_lin_unbal.png','-dpng','-r900');
...
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
matlab2tikz('filename',sprintf('boxpl_SP_best4_lin_unbal.tex'));
hgexport(gcf, 'boxpl_SP_best4_lin_unbal.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('boxpl_SP_best4_lin_unbal.fig')
print(gcf,'boxpl_SP_best4_lin_unbal.png','-dpng','-r900');

...
matlab2tikz('filename',sprintf('AbdulGhani_val_SPs_balanced.tex'));
hgexport(gcf, 'AbdulGhani_val_SPS_balanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_val_SPS_balanced.fig')

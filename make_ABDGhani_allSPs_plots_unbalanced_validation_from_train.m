...
h4 = plot(1:10,std_val_ACC, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','blue',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h5 = plot(1:10,std_val_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','red',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h6 = plot(1:10,std_val_SP, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','green',...
    'MarkerSize',9,...
    'LineWidth',0.5);
...
matlab2tikz('filename',sprintf('AbdulGhani_val_from_train_SPs_unbalanced.tex'));
hgexport(gcf, 'AbdulGhani_val_from_train_SPS_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_val_from_train_SPS_unbalanced.fig')
...
h4 = plot(1:10,std_tr_ACC, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','blue',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h5 = plot(1:10,std_tr_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','red',...
    'MarkerSize',9,...
    'LineWidth',0.5);

h6 = plot(1:10,std_tr_SP, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','green',...
    'MarkerSize',9,...
    'LineWidth',0.5);
...
matlab2tikz('filename',sprintf('AbdulGhani_tra_SPs_unbalanced.tex'));
hgexport(gcf, 'AbdulGhani_tra_SPS_unbalanced.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
savefig('AbdulGhani_tra_SPS_unbalanced.fig')
...
ft = ft(:,[46;15;16;2;21;14;12;13;19;20]);
ft = ft(:,[1,2,3,7]);
FT = table2array(ft);
...
for iter = 1 : 100
    ...
    health_idx = randperm (round(7.5*size(val_dmi,1)));
    ...
    for NbF = 4 : 4 % : 3 %Features Selected (60 in total)
...
%                     'options',options);
    ...
    matfile = sprintf('%s_%d','newBest_4F_rbf_bal_11',iter);

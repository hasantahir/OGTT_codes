...
grid on; box on
title('Validation')
matlab2tikz('filename',sprintf('AbdulGhani_val_SNs.tex'));

hgexport(gcf, 'AbdulGhani_val_SNs.jpg', hgexport('factorystyle'), 'Format', 'jpeg');
...
grid on; box on
title('Training')
matlab2tikz('filename',sprintf('AbdulGhani_tra_SNs.tex'));

hgexport(gcf, 'AbdulGhani_tra_SNS.jpg', hgexport('factorystyle'), 'Format', 'jpeg');

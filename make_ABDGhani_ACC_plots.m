...
for i = 1 : numFeatures
    ...
    for j = 1 : numIterations
        ...
        val_SEN(i,j) = Validation_results(j).sn_max_acc(i);
...
plot(1:10,mean_val_ACC, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor',[0.5 0.5 0.5],...
    'MarkerSize',9,...
    'LineWidth',0.5);
...
grid on; box on
matlab2tikz('filename',sprintf('AbdulGhani_ACC_acc.tex'));
...
plot(1:10,mean_tr_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor',[0.5 0.5 0.5],...
    'MarkerSize',9,...
    'LineWidth',0.5);

plot(1:10,mean_val_SEN, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor',[0.5 0.5 0.5],...
    'MarkerSize',9,...
    'LineWidth',0.5);
...
legend('Training', 'Validation','location','southeast');
grid on; box on
matlab2tikz('filename',sprintf('AbdulGhani_SEN_acc.tex'));
...
plot(1:10,mean_tr_SP, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor',[0.5 0.5 0.5],...
    'MarkerSize',9,...
    'LineWidth',0.5);

plot(1:10,mean_val_SP, 's','MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor',[0.5 0.5 0.5],...
    'MarkerSize',9,...
    'LineWidth',0.5);
% 
...
legend('Training', 'Validation','location','southeast');
grid on; box on
matlab2tikz('filename',sprintf('AbdulGhani_SP_acc.tex'));
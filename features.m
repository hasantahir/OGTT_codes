...
ft = table2array(SAHS_clean(:,2:12));
...
glucose = table2array(SAHS_clean(:, 5:8))';
insulin = table2array(SAHS_clean(:, 9:12))';
...
dmi = table2array(SAHS_clean(:, 17))';
cvi = table2array(SAHS_clean(:, 18))';
...
ft.AGE = table2array(SAHS_clean(:, 2));

ft.ETHN = table2array(SAHS_clean(:, 3));

ft.BMI = table2array(SAHS_clean(:, 4));
